...
// // Pre-save hook: update reels when username or name changes
...
//       { user: this._id },   // Keep ObjectId reference
//       { $set: update }
//     );
...
// // Static method to generate a unique username if not provided
...
// // ✅ Pre-save hook to ensure userid consistency across models
// userSchema.pre("save", async function (next) {
//   try {
//     if (!this.isNew) return next();

//     // Make sure userid is string and unique
...
//     // Update any documents related to this user (if created with temp userid)
//     const updateModels = [Reel, Music, Comment];

//     for (const Model of updateModels) {
//       await Model.updateMany(
//         { uploadedBy: this._id },  // For Music
//         { $set: { userid: this.userid } } // Ensure userid consistent
//       );
//     }
