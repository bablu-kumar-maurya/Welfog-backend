...
//       logout: <MdLock className="text-gray-500" />,
...
//       unfollow_user: <MdPerson className="text-gray-500" />,
...
//       Published: 'bg-green-600/20 text-green-500',
//       Processing: 'bg-yellow-600/20 text-yellow-500',
//       Deleted: 'bg-gray-600/20 text-gray-500',
//     };
//     return colorMap[status] || 'bg-gray-600/20 text-gray-500';
//   };
...
//       <div
//         key={activityKey}
//         className="bg-dark-800 border border-dark-700 rounded-lg p-4 hover:border-dark-600 transition-colors flex items-start gap-4"
//       >
...
//                 className="mt-2 text-primary-500 text-sm flex items-center gap-1 hover:text-primary-400"
//               >
...
//             {/* Expanded metadata */}
//             {isExpanded && (
//               <div className="mt-3 p-3 bg-dark-900 rounded border border-dark-700 text-xs space-y-2">
//                 {metadata.device && (
//                   <div>
...
//                     <span className="text-white">{metadata.browser}</span>
//                   </div>
//                 )}
//                 {metadata.location && (
//                   <div>
...
//                     <span className="text-white">{metadata.views}</span>
//                   </div>
//                 )}
//                 {metadata.likes !== undefined && (
//                   <div>
//                     <span className="text-dark-400">Likes:</span>{' '}
//                     <span className="text-white">{metadata.likes}</span>
//                   </div>
//                 )}
//                 {metadata.reason && (
//                   <div>
//                     <span className="text-dark-400">Reason:</span>{' '}
//                     <span className="text-white">{metadata.reason}</span>
//                   </div>
//                 )}
//                 {metadata.reelId && (
//                   <div>
//                     <span className="text-dark-400">Reel ID:</span>{' '}
//                     <span className="text-white font-mono">{metadata.reelId}</span>
//                   </div>
//                 )}
//                 {metadata.commentId && (
//                   <div>
//                     <span className="text-dark-400">Comment ID:</span>{' '}
//                     <span className="text-white font-mono">{metadata.commentId}</span>
//                   </div>
//                 )}
//               </div>
//             )}
...
//           <MdChevronRight className="text-dark-400 text-2xl" />
//         </div>
//       </div>
//     );
//   };
...
//             className="p-2 bg-dark-800 hover:bg-dark-700 text-white rounded-lg transition-colors"
//           >
//             <MdArrowBack className="text-xl" />
//           </button>
//           <div>
//             <h1 className="text-3xl font-bold text-white mb-2">User Activity Details</h1>
//             {user && (
...
//                   {user.name && <span className="text-dark-300">({user.name})</span>}
//                 </div>
...
//             className="bg-dark-900 border border-dark-700 rounded-xl p-4 cursor-pointer hover:border-primary-500 transition flex items-center justify-between"
//           >
//             <div>
...
//               </p>
//             </div>
//             <MdChevronRight className="text-dark-400 text-2xl flex-shrink-0" />
//           </div>
//           <div
...
//           <MdFilterList className="text-dark-400 text-xl" />
...
//           {/* Date Range */}
//           <div>
//             <label className="block text-dark-400 text-sm mb-2">Start Date</label>
//             <input
//               type="date"
//               value={startDate}
//               onChange={(e) => {
...
//           <div>
//             <label className="block text-dark-400 text-sm mb-2">End Date</label>
//             <input
//               type="date"
//               value={endDate}
//               onChange={(e) => {
...
//         {/* Search */}
//         <div>
//           <label className="block text-dark-400 text-sm mb-2">Search</label>
...
//               className="w-full pl-12 pr-4 py-2 bg-dark-800 border border-dark-700 rounded-lg text-white placeholder-dark-500 focus:outline-none focus:ring-2 focus:ring-primary-500"
//             />
//           </div>
//         </div>
//       </div>
...
//         <h2 className="text-white font-semibold text-xl mb-4">Activity Timeline</h2>
...
//               }}
//               className="px-4 py-2 bg-dark-800 text-white rounded disabled:opacity-40 disabled:cursor-not-allowed hover:bg-dark-700"
//             >
//               &lt; Previous
//             </button>
