...
//   // Fetch music whenever page or searchTerm changes
//   useEffect(() => {
...
//         behavior: 'smooth', // no smooth jump
//         block: 'start',
//       });
//     }
//   }, [page]);

//   const fetchMusic = async (pageNumber = 1, search = '') => {
//     try {
//       setLoading(true);
//       const res = await axios.get(
//         `/api/music?page=${pageNumber}&limit=${LIMIT}&search=${search}`
//       );

//       const tracks = Array.isArray(res.data?.data) ? res.data.data : [];
//       setMusicTracks(tracks);
//       setFilteredTracks(tracks); // no frontend filtering needed if backend handles search
...
//             className="w-full pl-12 pr-4 py-3 bg-dark-800 border border-dark-700 rounded-lg text-white placeholder-dark-500 focus:outline-none focus:ring-2 focus:ring-primary-500"
//           />
//         </div>
//       </div>
...
//           <div
//             key={track._id}
//             className="bg-dark-900 border border-dark-700 rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 hover:scale-105"
//           >
//             {/* Thumbnail */}
...
//                   <MdMusicNote className="text-6xl text-dark-600" />
//                 </div>
//               )}
//             </div>
...
//           {/* Modal */}
//           <div className="bg-dark-900 border border-dark-700 rounded-xl w-[450px] h-[450px] p-4 flex flex-col">

//             {/* Header */}
//             <div className="flex-shrink-0 text-center border-b border-dark-700 pb-2 mb-2">
//               <h2 className="text-white text-2xl font-bold">Music Details</h2>
//             </div>
...
//                 <p><span className="text-dark-400 font-medium">Title:</span> {selectedTrack.title || 'Unknown'}</p>
//                 <p><span className="text-dark-400 font-medium">Artist:</span> {selectedTrack.artist || 'Unknown'}</p>
//                 {selectedTrack.duration && (
//                   <p><span className="text-dark-400 font-medium">Duration:</span> {Math.floor(selectedTrack.duration / 60)}:{String(selectedTrack.duration % 60).padStart(2, '0')}</p>
//                 )}
//                 <p><span className="text-dark-400 font-medium">Created:</span> {new Date(selectedTrack.createdAt).toLocaleString()}</p>
//               </div>
...
//     <div className="bg-dark-900 border border-dark-700 rounded-lg p-5 w-[320px] max-w-full">
...
//         This music track will be permanently deleted. This action cannot be undone.
//       </p>
